...
def test_client_manager_import_does_not_start_threads_or_crash():
    with (
        mock.patch("client_manager.DockerThread"),
        mock.patch("client_manager.JobThread"),
        mock.patch("client_manager.OpenstackThread"),
        mock.patch("client_manager.TritonThread"),
        mock.patch("client_manager.WebSocketThread"),
        mock.patch("client_manager.configure_logging"),
    ):
