...
from ..openstackerrors import OpenstackDeletionMissingVM, OpenstackDeletionError, OpenstackDeletionTimeout
...
class OpenstackDeletion:
    ...
    def handle(self, vm_id: str):
        ...
        try:  
            # --- Send delete request ---
            response = requests.delete(url     = full_endpoint,
            ...
            if e.response.status_code == 404: raise OpenstackDeletionMissingVM(vm_id)
            else:                             raise OpenstackDeletionError(e, vm_id)
