...
if TYPE_CHECKING: from ..auth import OpenstackAuth

from .data import VM, Host, Flavor, Image, Network, Keypair, Security
import requests
...
class OpenstackInfo:
    ...
    def headers(self):
        ...
        return {"X-Auth-Token": self.auth.token,
    ...
    # --------------- INFO ---------------
    def load_vms(self):      return self._load('vms')
    def load_hosts(self):    return self._load('hosts')
    def load_images(self):   return self._load('images')
    def load_flavors(self):  return self._load('flavors')
    def load_networks(self): return self._load('networks')
    def load_keypairs(self): return self._load('keypairs')
    def load_security(self): return self._load('security')
