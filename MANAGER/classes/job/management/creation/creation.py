...
class JobCreation:
    ...
    def handle(self, msg_uuid: str, payload: dict) -> dict:
        ...
        # ------------ Create Container ------------
        try: container_id, _ = self._container.handle(msg_uuid, payload, vm_ip=vm_ip)
        except Exception:
        ...
        # ------------ Create Server ------------
        try: result = self._triton.handle(msg_uuid, payload, vm_id = vm_id, vm_ip = vm_ip, container_id = container_id)
        except Exception:
